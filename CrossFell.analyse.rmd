...
1. Outliers: look for individual points on the box plots

2. Skewness: density plot will be skewed and boxplots will be asymmetrical.

3. Unequal variance: box sizes are very unequal.  If there is little data, then this may not be reliable, as variances can appear unequal when they aren't.
